...
function loaddata() {
  var url = "http://localhost/ledprojectapp/api/weather/read_all.php";
  console.log(url);
  ...
  $.getJSON(url, function (data) {
    ...
    var gsurl =
      "https://script.google.com/macros/s/AKfycbwGZUmKfP68CkXgyFiSgYeMjx0lUSOkZXYW5J8H8NgEX2RbNQCYYZPA09iXIQr8JlTCwQ/exec?func=addData&val="
        .temp;
    fetch(gsurl).then((response) => {
